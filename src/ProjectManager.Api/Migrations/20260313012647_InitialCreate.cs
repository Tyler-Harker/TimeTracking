        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultBillableRate = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationClients", x => new { x.OrganizationId, x.ClientId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "OrganizationClientProjects",
                columns: table => new
                {
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    ClientId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationClientProjects", x => new { x.OrganizationId, x.ClientId, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_OrganizationClientProjects_OrganizationClients_Organization~",
                        columns: x => new { x.OrganizationId, x.ClientId },
                        principalTable: "OrganizationClients",
                        principalColumns: new[] { "OrganizationId", "ClientId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganizationClientProjects_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    BillableRate = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    IsBillable = table.Column<bool>(type: "boolean", nullable: false),
                    IsInvoiced = table.Column<bool>(type: "boolean", nullable: false),
                    InvoiceLineItemId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationClientProjects_ProjectId",
                table: "OrganizationClientProjects",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_OrganizationId_UserId_Date",
                table: "TimeEntries",
