...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateOrganizationRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.defaultBillableRate, defaultBillableRate) || other.defaultBillableRate == defaultBillableRate));
}
...
@override
String toString() {
  return 'CreateOrganizationRequest(name: $name, description: $description, defaultBillableRate: $defaultBillableRate)';
}
...
class _CreateOrganizationRequest implements CreateOrganizationRequest {
  const _CreateOrganizationRequest({required this.name, this.description, this.defaultBillableRate});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateOrganizationRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.defaultBillableRate, defaultBillableRate) || other.defaultBillableRate == defaultBillableRate));
}
