...
mixin _$UpdateOrganizationRequest {
 ...
 String get name; String? get description; double? get defaultBillableRate;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateOrganizationRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.defaultBillableRate, defaultBillableRate) || other.defaultBillableRate == defaultBillableRate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,description,defaultBillableRate);

@override
String toString() {
  return 'UpdateOrganizationRequest(name: $name, description: $description, defaultBillableRate: $defaultBillableRate)';
}
...
@useResult
$Res call({
 String name, String? description, double? defaultBillableRate
});
...
/// Create a copy of UpdateOrganizationRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = freezed,Object? defaultBillableRate = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String? description,  double? defaultBillableRate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateOrganizationRequest() when $default != null:
return $default(_that.name,_that.description,_that.defaultBillableRate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String? description,  double? defaultBillableRate)  $default,) {final _that = this;
switch (_that) {
case _UpdateOrganizationRequest():
return $default(_that.name,_that.description,_that.defaultBillableRate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String? description,  double? defaultBillableRate)?  $default,) {final _that = this;
switch (_that) {
case _UpdateOrganizationRequest() when $default != null:
return $default(_that.name,_that.description,_that.defaultBillableRate);case _:
  return null;
...
class _UpdateOrganizationRequest implements UpdateOrganizationRequest {
  const _UpdateOrganizationRequest({required this.name, this.description, this.defaultBillableRate});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateOrganizationRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.defaultBillableRate, defaultBillableRate) || other.defaultBillableRate == defaultBillableRate));
}
...
/// Create a copy of UpdateOrganizationRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = freezed,Object? defaultBillableRate = freezed,}) {
