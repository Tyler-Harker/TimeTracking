...
export default function ProjectTimeEntryNewPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setSaving(true);
    try {
      await timeEntryRepository.create({ projectId: params.projectId, date, hours: parseFloat(hours), description: description || undefined, isBillable });
  ...
  return (
    <div className="p-6 max-w-2xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Log Time</CardTitle>
        </CardHeader>
        <CardContent>
          {error && (
